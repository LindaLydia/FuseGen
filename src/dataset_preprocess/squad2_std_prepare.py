...
input_file = './data/squad2/validation-00000-of-00001.parquet'
output_file = './data/squad2/std/test.jsonl'

input_file = './data/squad2/train-00000-of-00001.parquet'
output_file = './data/squad2/std/train.jsonl'
