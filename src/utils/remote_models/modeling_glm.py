...
class GLMStack(torch.nn.Module):
    ...
    def forward(self, hidden_states, position_ids, attention_mask, memory_states=None):
        ...
        # print(f"in <modeling_glm.py> {attention_mask.device=} {position_ids.device=}")
        # print(f"in <modeling_glm.py> is_scaler={is_scalar}")
...
class GLMModel(GLMPreTrainedModel):
    ...
    def forward(
        ...
        # print(f"<modeling_glm.py> {attention_mask=}")
...
class GLMForConditionalGeneration(GLMPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, past=None, position_ids=None, attention_mask=None,
                                      **kwargs):
        # only last token for inputs_ids if past is defined in kwargs
        # print(f"<modeling_glm.py> {position_ids=}")
        # print(f"<modeling_glm.py> {attention_mask.shape=}")
        # print(f"<modeling_glm.py> {attention_mask.shape}")
